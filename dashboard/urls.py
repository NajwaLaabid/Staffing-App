...
urlpatterns =  [
    ...
    url(r'^saveMemberHours/(?P<project_id>\d+)/(?P<nb_dates>\d+)/$', views.saveMemberHours, name='saveMemberHours'),
    ...
    url(r'^deleteDeliverable/(?P<project_ID>\d+)/$', views.deleteDeliverable, name='deleteDeliverable'),
    url(r'^deleteDeliverableGroup/(?P<project_ID>\d+)/$', views.deleteDeliverableGroup, name='deleteDeliverableGroup'),
    url(r'^editDeliverableGroup/(?P<project_ID>\d+)/(?P<deliv_group>.+)/$', views.editDeliverableGroup, name='editDeliverableGroup'),
    url(r'^deletePossibleDeliverable/(?P<project_ID>\d+)/$', views.deletePossibleDeliverable, name='deletePossibleDeliverable'),
